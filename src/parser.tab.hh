  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_DOT = 18,                              // "."
        S_COMMA = 19,                            // ","
        S_OPEN_SQUARE_BRAC = 20,                 // "["
        S_CLOSE_SQUARE_BRAC = 21,                // "]"
        S_OPEN_CURLY = 22,                       // "{"
        S_CLOSE_CURLY = 23,                      // "}"
        S_OPEN_PARENTHESIS = 24,                 // "("
        S_CLOSE_PARENTHESIS = 25,                // ")"
        S_ID = 26,                               // "identifier"
        S_UNIOP = 27,                            // UNIOP
        S_28_unary_operator_ = 28,               // "unary operator"
        S_BIOP = 29,                             // BIOP
        S_30_binary_operator_ = 30,              // "binary operator"
        S_INT = 31,                              // "integer"
        S_STRING = 32,                           // "string"
        S_BOOL = 33,                             // "boolean"
        S_DOUBLE = 34,                           // "double"
        ...
        S_program_element = 40,                  // program_element
        S_constant = 41,                         // constant
        S_declare = 42,                          // declare
        S_declaration_stmt = 43,                 // declaration_stmt
        S_assignment_stmt = 44,                  // assignment_stmt
        S_variable = 45,                         // variable
        S_assignment_target = 46,                // assignment_target
        S_array_initializer = 47,                // array_initializer
        S_struct_declaration = 48,               // struct_declaration
        S_struct_member_list = 49,               // struct_member_list
        S_expression = 50,                       // expression
        S_expression_list = 51,                  // expression_list
        S_table_expression = 52,                 // table_expression
        S_statement = 53,                        // statement
        S_return_stmt = 54,                      // return_stmt
        S_statement_list = 55,                   // statement_list
        S_compound_statement = 56,               // compound_statement
        S_variable_list = 57,                    // variable_list
        S_parameter_list = 58,                   // parameter_list
        S_function_definition = 59,              // function_definition
        S_function_body = 60                     // function_body
      };
    };
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::YYEOF
                   || (token::YYerror <= tok && tok <= token::CLOSE_PARENTHESIS));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::ID <= tok && tok <= 285)
                   || tok == token::STRING
                   || tok == token::RANGE);
#endif
      }
