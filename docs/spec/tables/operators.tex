...
\ifthenelse{\isundefined{\gnumericColE}}{\newlength{\gnumericColE}}{}\settowidth{\gnumericColE}{\begin{tabular}{@{}p{107pt*\gnumericScale}@{}}x\end{tabular}}
\ifthenelse{\isundefined{\gnumericColF}}{\newlength{\gnumericColF}}{}\settowidth{\gnumericColF}{\begin{tabular}{@{}p{158pt*\gnumericScale}@{}}x\end{tabular}}
...
\hhline{|------|}
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 ...
	 \multirow{6}[3]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 \gnumericPB{\centering}int, double}}}
	&\multicolumn{1}{p{\gnumericColF}|}%
	{\gnumericPB{\centering}ADD(2,3)}
\\
\hhline{~|--|~~|-|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}SUB}
	&\multicolumn{1}{p{\gnumericColC}|}%
	...
	{}
	&\multicolumn{1}{p{\gnumericColF}|}%
	{\gnumericPB{\centering}SUB(myTable[1,2],5)}
\\
\hhline{~|--|~~|-|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}MUL}
	&\multicolumn{1}{p{\gnumericColC}|}%
	...
	{}
	&\multicolumn{1}{p{\gnumericColF}|}%
	{\gnumericPB{\centering}MUL(myTable[1:5:1],10)}
\\
\hhline{~|--|~~|-|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}DIV}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{~|--|~|--|}
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 ...
	 \gnumericPB{\centering}int, double}}}
	&\multicolumn{1}{p{\gnumericColF}|}%
	{\gnumericPB{\centering}cell1 $>$ 100}
\\
\hhline{~|--|~~|-|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
...
\hhline{~|--|~~|-|}
	...
	{}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}BXOR}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}Bitwise XOR}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{}
	&\multicolumn{1}{p{\gnumericColF}|}%
	{\gnumericPB{\centering}BXOR(cell1, 2)}
\\
\hhline{~|--|~~|-|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}BNOT}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}Bitwise NOT}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{}
	&\multicolumn{1}{p{\gnumericColF}|}%
	{\gnumericPB{\centering}BNOT(cell1)}
\\
\hhline{~|--|~~|-|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}BLS}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}Bitwise Left Shift}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{}
	&\multicolumn{1}{p{\gnumericColF}|}%
	{\gnumericPB{\centering}BLS(cell1, 2)}
\\
\hhline{~|--|~~|-|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}BRS}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}Bitwise Right Shift}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{}
	&\multicolumn{1}{p{\gnumericColF}|}%
	{\gnumericPB{\centering}BRS(cell1, 2)}
\\
\hhline{|------|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{~|--|~|--|}
	...
	{\gnumericPB{\centering}[ ]}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}Array Reference}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{\gnumericPB{\centering}array}
	&\multicolumn{1}{p{\gnumericColF}|}%
	{\gnumericPB{\centering}Num[1][5]}
\\
\hhline{|------|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
