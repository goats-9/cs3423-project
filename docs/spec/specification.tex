...
\title{Tabulate\\Language Specification}
...
\begin{table}[!ht]
  ...
  \vspace{3mm}
  \caption{Some keywords in Tabulate.}
  \label{tab:keywords}
\end{table}
...
\begin{table}[!ht]
  \input{tables/non-primitives.tex}
  \vspace{3mm}
...
\lstinputlisting[label={code:declaration}, caption={Declaration Statements in Tabulate}, captionpos={b}]{codes/decl_stmt.tblt}
...
\lstinputlisting[label={code:assignment}, caption={Assignment Statements in Tabulate}, captionpos={b}]{codes/assgn_stmt.tblt}
...
\lstinputlisting[label={code:function-calls}, caption={Function Calls in Tabulate}, captionpos={b}]{codes/func_call.tblt}

\subsubsection{Return Statements}
The syntax for return statements is given in \autoref{code:return}.

\lstinputlisting[label={code:return}, caption={Return Statements in Tabulate}, captionpos={b}]{codes/return_stmt.tblt}

\subsubsection{Expression Statements}
Expression statements in Tabulate must contain a left and right hand side, as
shown in \autoref{code:expressions}.

\lstinputlisting[label={code:expressions}, caption={Expression Statements in Tabulate}, captionpos={b}]{codes/expressions.tblt}
...
\lstinputlisting[label={code:jumps}, caption={Jump Statements in Tabulate}, captionpos={b}]{codes/jump_stmt.tblt}
...
\lstinputlisting[label={code:compound}, caption={Compound Statements in Tabulate}, captionpos={b}]{codes/cmpd_stmt.tblt}
...
\lstinputlisting[label={code:selection}, caption={Selection Statements in Tabulate}, captionpos={b}]{codes/sel_stmt.tblt}

\subsection{Iteration Statements}
Tabulate offers one iteration statement construct, illustrated in
\autoref{code:iter}.

\lstinputlisting[label={code:iter}, caption={Iteration Statements in Tabulate}, captionpos={b}]{codes/iter_stmt.tblt}
...
\lstinputlisting[label={code:function-def}, caption={Function Definitions in Tabulate}, captionpos={b}]{codes/func.tblt}

\subsection{Main Function}
Programs that can be executed \emph{must} contain a \texttt{main} function, as
illustrated in \autoref{code:function-main}.

\lstinputlisting[label={code:function-main}, caption={Usage of Main Function in Tabulate}, captionpos={b}]{codes/main.tblt}
