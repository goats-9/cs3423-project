...
Identifiers in Tabulate can contain characters and digits. However, they must
...
In Tabulate, the simplest type of statements are \emph{expression statements}.
These statements are delimited with a semicolon.
